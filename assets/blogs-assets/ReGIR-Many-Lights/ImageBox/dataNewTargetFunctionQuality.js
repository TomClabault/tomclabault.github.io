var dataNewTargetFunctionQuality = {
    "imageBoxes": [    
        {
            "title": "ReGIR better grid fill target functions. Grid size 0.5, L=32, R=64, S=1",
            "elements": [
                {
                    "title": "The white room",
                    "elements": [
						{
                            "image": "/assets/blogs-assets/ReGIR-Many-Lights/ImageBox/imgs/regir-new-target-function-quality/regir-simple-twr.png",
                            "title": "ReGIR - Le/d^2"
                        },
                        {
				...
				
				{
                    ...
                    "elements": [
						{
                            "image": "/assets/blogs-assets/ReGIR-Many-Lights/ImageBox/imgs/regir-new-target-function-quality/regir-simple-bistro.png",
                            "title": "ReGIR - Le/d^2"
                        },
                        {
				...
				
				{
                    ...
                    "elements": [
						{
                            "image": "/assets/blogs-assets/ReGIR-Many-Lights/ImageBox/imgs/regir-new-target-function-quality/regir-simple-bzd.png",
                            "title": "ReGIR - Le/d^2"
                        },
                        {
