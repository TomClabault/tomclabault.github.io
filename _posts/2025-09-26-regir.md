...
ADD VIS REUSE IMAGE COMPARISONS

But I did not keep that visibility reuse pass because of its cost to remain unbiased.

> ##### Note
>
> Writing this, I realize that maybe NEE++ could be used to significantly reduce the bias (although not completely)
> of not including visibility rays in the MIS weights but including the NEE++ visibility probability instead.
{: .block-tip }

## Fixing the bias
One major piece of the puzzle that we've been side-stepping since the beginning is that:
...
## Multiple Importance Sampling
	...
	- Introduce shading resampling with many neighbors here
