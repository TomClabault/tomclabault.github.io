...
of 32 steps for linear probing, that's not amazing when compared to the results of the survey on GPU hash tables from Awad et al. 2021 {% cite awad2021bettergpuhashtables %}. Their introduction report
...
Transition by saying that increasing the number of grid fill samples helps
...
## Visibility reuse
First tests good but too expensive, and even more expensive to maintain unbiasedness, shadow rays everywhere needed
