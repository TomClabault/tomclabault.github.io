...
If the 5 samples $X_1$ $X_5$ that we generate all end up being on a light source that is occluded from the cameraa-ray first hit $P$ that we're trying to shade,
