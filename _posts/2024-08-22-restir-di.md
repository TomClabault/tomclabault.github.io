...
we can't easily compute<d-cite key="bitterli2020spatiotemporal"></d-cite> the PDF of the resulting sample $Y$. What we can compute however, is an estimate of
